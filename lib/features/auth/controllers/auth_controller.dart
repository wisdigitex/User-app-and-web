...
class AuthController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> loginEmail(String? email, String password) async {
    _isLoading = true;
    update();
    ResponseModel responseModel = await authServiceInterface.emailLogin(email: email, password: password);
  ...
  Future<void> saveUserEmailAndPasswordSharedPref(String email, String password) async {
    await authServiceInterface.saveUserEmailAndPassword(email, password);
  }
