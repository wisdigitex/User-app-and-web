...
class SignInScreenState extends State<SignInScreen> {
  ...
  void _login(AuthController authController, String countryDialCode) async {
    ...
    print("Country Code : $countryDialCode");
    ...
    if (_formKeyLogin!.currentState!.validate()) {
      ...
      if (email.isEmpty) {
        ...
        authController.loginEmail(email, password).then((status) async {
          if (status.isSuccess) {
            ...
            if (authController.isActiveRememberMe) {
              ...
              authController.saveUserEmailAndPasswordSharedPref(email, password);
            } else {
            ...
            if (Get.find<SplashController>()
              ...
              /*if (Get.find<SplashController>()
                ...
                Get.toNamed(RouteHelper.getVerificationRoute(email, token, RouteHelper.signUp, data));
              }*/
              List<int> encoded = utf8.encode(password);
              String data = base64Encode(encoded);
              Get.toNamed(RouteHelper.getVerificationRoute(email, token, RouteHelper.signUp, data));
